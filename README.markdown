...
(I want to improve my Javascript-fu. Therefore, I thought
it good to find a project similar to the [Ruby
Koans](http://rubykoans.com/).  See this blog
[post](http://blog.blazingcloud.net/2012/12/28/javascript-koans/)).
